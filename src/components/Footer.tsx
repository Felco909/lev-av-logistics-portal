        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-10 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="text-[10px] font-mono text-[#777] space-y-1 bg-[#111318] p-3 border border-white/10">
              <div className="text-white font-bold">{lang === 'ru' ? 'ИНН: 02248043' : 'TIN: 02248043'}</div>
              <div className="truncate">
                {lang === 'ru' ? 'РА, 0046, г. Ереван, ул. С. Таронци 3/1, кв. 18' : 'RA, 0046, Yerevan, S. Tarontsi St. 3/1, Apt. 18'}
              </div>
            </div>
          </div>
